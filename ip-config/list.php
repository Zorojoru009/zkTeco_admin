...
function openModalPHP($type){
    ...
    function openModal(type) {
        $(document).ready(function() {
            ...
            if(type == 1){
                headingElement.textContent = 'IP Successfully Changed';
...
if($feedbackMessage == "changeBranchNumberSuccess"){
    openModalPHP(2);
} elseif($feedbackMessage == "changeIpSuccess"){
    openModalPHP(1);
    ...
    <div class="card-body ">
        ...
        <div class="row" style="text-align:center;">
            ...
            <div class="col-lg-6 mb-3">
                <form method="post" action="process.php?action=changeIp" style="text-align:center;">
                    <label for="simpleinput" class="form-label">Change Ip</label>
                    <br>
                    <input style="text-align:center" type="text" value="<?php 
                      echo $branch_data['ip'];
                    ?>" name="ip" id="simpleinput" class="form-control">
                    <br>
