...
?>
<form class="needs-validation" novalidate method="post" action="process.php?action=add" enctype="multipart/form-data"
    name="form" id="form">
    <div class="content">
        <!-- Start Content-->
                    ...
                    <div class="card">
						...
						?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="e_fname"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom02" name="e_mname"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom03" name="e_lname"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom04" name="suffix"
                                    placeholder="Suffix" autocomplete="off" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="basic-datepicker" class="form-control" name="dob"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom05" name="e_contact_o"
                                    placeholder="Contact number 1" onKeyUp="checkNumber(this);" autocomplete="off"
                                    required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom06" name="e_contact_t"
                                    placeholder="Contact number 2" onKeyUp="checkNumber(this);" autocomplete="off"
                                    required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="validationCustom07" name="e_paddress"
                                    placeholder="Primary Address" required></textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="validationCustom08" name="e_saddress"
                                    placeholder="Secondary Address" required></textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="salary" name="salary" placeholder="Salary"
                                    onKeyUp="checkNumber(this);" autocomplete="off" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="num_hrs" name="num_hrs"
                                    placeholder="Number of hours" onKeyUp="checkNumber(this);" autocomplete="off"
                                    required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sss_num" name="sss_num"
                                    placeholder="SSS number" onKeyUp="checkNumber(this);" autocomplete="off" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tin_num" name="tin_num"
                                    placeholder="TIN number" onKeyUp="checkNumber(this);" autocomplete="off" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pag_num" name="pag_num"
                                    placeholder="Pag-ibig number" onKeyUp="checkNumber(this);" autocomplete="off"
                                    required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phil_num" name="phil_num"
                                    placeholder="Phil health number" onKeyUp="checkNumber(this);" autocomplete="off"
                                    required />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="rfid" name="rfid"
                                    placeholder="Tap your card" onKeyUp="checkNumber(this);" autocomplete="off"
                                    required />
                                <div class="invalid-feedback">
