...
<div class="card">
    <div class="card-body ">
        ...
        <div class="row" style="text-align:center;">
            ...
            <div class="col-lg-6 mb-3">
                <form method="post" action="process.php?action=updateBranch" style="text-align:center;">
                    <label for="branchLocation" class="form-label">INITIALIZE BRANCH</label>
                    <br>
                    <input type="hidden" name="latitude" id="latitude">
                    <input type="hidden" name="longitude" id="longitude">
                    <input readonly value="" class="form-control" id="location" type="text" style="text-align:center;"
                        name="branchLocation">
                    <br>
                    <button type="submit" class="btn btn-success">Update Branch to Main Web Control </button>
                </form>
            </div>
...
function showPosition(position) {
  ...
  latitudeInput.value= position.coords.longitude;
}
